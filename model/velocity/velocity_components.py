"""
Neural network sub-components (MTN, NCN, etc.) for the velocity model.
"""
...
class NCN(nn.Module):
    """Enterprise class definition for NCN."""
...
class CausalConv1d(nn.Conv1d):
    """Enterprise class definition for CausalConv1d."""
...
class MTNTCNBlock(nn.Module):
    """Enterprise class definition for MTNTCNBlock."""
...
class MTN(nn.Module):
    """Enterprise class definition for MTN."""

    def __init__(self):
        """Initializes the instance."""
        super().__init__()
        self.embed = nn.Sequential(nn.Linear(6, 32), nn.ReLU(), nn.Linear(32, 64), nn.ReLU())
        self.tcn = nn.Sequential(
            MTNTCNBlock(64, kernel_size=2, dilation=1), MTNTCNBlock(64, kernel_size=2, dilation=2)
        )
